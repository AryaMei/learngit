<p align="center">Table 1 – Price and tensile strength comparison of polyester, vinyl ester and epoxy resins</p>
<table align="center">
...
<p align="center">表1-聚酯、乙烯基树脂及环氧树脂的价格和强度对比</p>
<table align="center">
    <tr align="center" style="font-weight: 800;">
...
<p align="center">Table 2 – Common additives and fillers and their effect on resin properties</p>
<table align="center">
    <tr align="center" style="font-weight: 800;">
        <td ></td> 
        <td></td> 
...
<p align="center">表2 常用的添加剂和填料及其对树脂性能的影响</p>
<table align="center">
    <tr align="center" style="font-weight: 800;">
        <td ></td> 
        <td></td> 
...
<p align="center">Table 3 - Advantages and disadvantages of mix homogeneity characterization methods</p>
<table align="center">
    <tr align="center" style="font-weight: 800;">
...
<p align="center">表3-混合均匀性表征方法的优缺点</p>
<table align="center">
    <tr align="center" style="font-weight: 800;">
        <td >表征方法</td> 
        <td>优点</td> 
...
<p align="center">Table 4 – Popular types of static mixers</p>
<table align="center">
     <tr align="center" style="font-weight: 800;">
        <td >Type/Name</td> 
        <td>3D model[73]</td> 
     ...
     <tr align="center">
        ...
        <td><img src="./pic/table4_1.png" alt="图片1" width="300px"></td> 
     </tr>
     <tr align="center">
        <td >SMX (Static Mixer using crossbars X)</td> 
        <td><img src="./pic/table4_2.png" alt="图片2" width="300px"></td> 
     </tr>
     <tr align="center">
        <td >LPD (Low Pressure Drop)</td> 
        <td><img src="./pic/table4_3.png" alt="图片3" width="300px"></td> 
     </tr>
</table>

***

<p align="center">Table 5 - Mixing performance analysis of static mixers</p>
<table align="center">
     <tr align="center" style="font-weight: 800;">
        <td ></td> 
        <td >ΔP(MPa)</td>
        <td >Mean  shear rate (s<sup>-1</sup>)</td>
...
<p align="center">Table 6 – Pressure drop and interfacial stretch of different static mixers</p>
<table align="center">
     <tr align="center" style="font-weight: 800;">
     ...
     <tr align="center">
          <td>Kenics (RL-180°) </td>
          <td>5.5</td>
          <td>2<sup style="font-style:italic;">N<sub>elem</sub></sup></td>
          <td>4<sup style="font-style:italic;">N<sub>elem</sub></sup>-1</td>
     </tr>
     <tr align="center">
          <td>LPD (RL-90°) </td>
          <td>8.5</td>
          <td>3<sup style="font-style:italic;">N<sub>elem</sub></sup></td>
          <td>2<sup style="font-style:italic;">N<sub>elem</sub></sup></td>
     </tr>
     <tr align="center">
          <td>SMX (2, 3, 8, 90°)</td>
          <td>38</td>
          <td>8<sup style="font-style:italic;">N<sub>elem</sub></sup>-1</td>
          <td>5<sup style="font-style:italic;">N<sub>elem</sub></sup></td>
     </tr>
</table> 

***
<p align="center">Table 7 - Comparison of static, dynamic and impingement mixers</p>
<table align="center">
     <tr align="center">
...
***
<p align="center">Table 8 - Project relevant flammable gas and vapour classification definitions in Canada</p>
<table>
     <tr align="center" style="font-weight: 800;">
...
<p align="center">Table 9 - Reviewed metering and mixing system technical data</p>
<table align="center">
     <tr align="center" style="font-weight: 800;">
          <td></td>
          <td>Mahr MarMax</td>
